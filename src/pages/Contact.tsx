    ...
    <div className="relative z-10 pt-24 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-left mb-10">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Collaboration</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start text-left">
        ...
        <div className="lg:col-span-7 relative">
          ...
          <GlowCard className="relative p-8" glowColor="green">
            <h3 className="text-base font-bold text-white mb-2">Technical RFP Integration Request</h3>
            <p className="text-xs text-slate-400 mb-6">Complete the briefing parameter list below to schedule your circular stream audit.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-dark-900 border border-slate-800 rounded-lg p-2.5 text-white placeholder-slate-655 focus:outline-none focus:border-emerald-500/50 resize-none"
                />
              </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 rounded-xl border border-slate-800 bg-dark-900/60">
            <h3 className="text-sm font-bold text-white mb-4 uppercase tracking-wider">Corporate Hubs</h3>
            
            <ul className="space-y-4">
              <li className="flex gap-3 items-start text-xs">
                <MapPin className="h-5 w-5 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-slate-200">Main Headquarters</h4>
                  <p className="text-slate-400 mt-1">Level 8, Climate Innovation Center, BKC, Mumbai, MH - 400051</p>
                </div>
              </li>
              <li className="flex gap-3 items-start text-xs">
                <Phone className="h-4.5 w-4.5 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-slate-200">Corporate Board Lines</h4>
                  <p className="text-slate-400 mt-0.5">+91 (022) 5892-3847</p>
                </div>
              </li>
              <li className="flex gap-3 items-start text-xs">
                <Mail className="h-4.5 w-4.5 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-slate-200">Partnership Inquiries</h4>
                  <p className="text-slate-400 mt-0.5">partner@ecoloop.tech</p>
                </div>
              </li>
              <li className="flex gap-3 items-start text-xs">
                <Clock className="h-4.5 w-4.5 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-slate-200">SLA Response Window</h4>
                  <p className="text-slate-400 mt-0.5">Less than 4 business hours for verified plants.</p>
                </div>
              </li>
            </ul>
          </div>
