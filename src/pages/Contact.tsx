            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-slate-850 placeholder-slate-400 focus:outline-none focus:border-blue-500/40"
                    required
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-slate-800 placeholder-slate-400 focus:outline-none focus:border-blue-500/40 resize-none"
                />
              </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 rounded-xl border border-slate-200 bg-white shadow-[0_4px_20px_rgba(148,163,184,0.04)]">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-3 items-start text-xs">
                <Phone className="h-4.5 w-4.5 text-blue-600 shrink-0 mt-0.5" />
                <div>
              ...
              <li className="flex gap-3 items-start text-xs">
                <Mail className="h-4.5 w-4.5 text-blue-600 shrink-0 mt-0.5" />
                <div>
