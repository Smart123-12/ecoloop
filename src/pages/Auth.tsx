      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
        ...
        <div className="hidden lg:col-span-6 lg:flex flex-col text-left gap-6">
          <div className="flex items-center gap-3">
            <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-tr from-teal-600 to-teal-500 shadow-[0_0_20px_rgba(20,184,166,0.15)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4.5 text-xs">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-full pl-9.5 pr-3 py-2.5 rounded-lg bg-slate-50 border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:border-teal-500/40"
                      required
                    />
              ...
              <div className="text-center mt-4">
                <button
                  ...
                  className="text-[11px] text-slate-500 hover:text-teal-600 font-semibold"
                >
