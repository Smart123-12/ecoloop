      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => setCurrentPage('home')}>
            <div className="relative flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-tr from-teal-600 to-teal-400 shadow-[0_0_15px_rgba(20,184,166,0.2)]">
              <Recycle className="h-6 w-6 text-white animate-spin-slow" style={{ animationDuration: '12s' }} />
            </div>
            <span className="text-xl font-bold tracking-tight bg-gradient-to-r from-slate-900 via-slate-800 to-teal-600 bg-clip-text text-transparent">
              EcoLoop
            </span>
          </div>
          ...
          <div className="flex lg:hidden">
            <button
              ...
              className="inline-flex items-center justify-center rounded-md p-2 text-slate-500 hover:bg-teal-500/10 hover:text-teal-600 focus:outline-none"
            >
